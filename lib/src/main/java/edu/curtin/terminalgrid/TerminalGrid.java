...
public class TerminalGrid
{
    ...
    public static TerminalGrid create(PrintStream out, int terminalWidth) {
    ...
    public void print(String[][] grid, String[] rowHeadings, String[] colHeadings)
    {
        ...
        // Make each column just wide enough to contain its longest line, before wrapping, though 
        // noting that some String values may _initially_ be broken into multiple lines anyway.
        ...
        // Split grid cells into lines, wrap each line (resulting in more lines), and so find the
        // height of each row.
